...
const ProductsToolbar = ({
  ...
  return (
    <div className="rounded-xl border border-border bg-surface p-3.5 mb-6 sticky top-20 z-30">
        ...
        <div className="flex items-center gap-2.5">
          {hasActiveFilters && (
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-danger/30 bg-danger-soft px-3.5 py-2 text-xs font-bold text-danger hover:bg-danger/10 transition-colors"
            >
          ...
          <select
            ...
            className="rounded-lg border border-border bg-input-bg px-3 py-2 text-sm text-foreground focus:border-brand-500 font-semibold"
          >
