...
const AdminLayout = () => {
  ...
  // Get admin avatar (using first letter of name)
  const getAdminInitials = () => {
    const name = getAdminName();
    return name.charAt(0).toUpperCase();
  };

  // Helper function to check if profile image exists and is valid
  const hasValidProfileImage = () => {
  return !!adminInfo?.profileImage; // true only if there's a real image
};
