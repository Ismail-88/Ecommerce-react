  ...
  return (
      <div className="rounded-2xl border border-warning/30 bg-warning-soft p-4">
        <div className="flex items-start gap-3">
          <span className="flex items-center justify-center w-10 h-10 rounded-xl bg-warning/20 text-warning flex-shrink-0">
            <AlertTriangle size={20} aria-hidden />
          </span>
          <div>
            <h3 className="font-semibold text-base mb-2 text-warning">
              Attention Required!
            </h3>
