      ...
      style={{backgroundImage:`url(${banner})`,backgroundPosition:"center", backgroundAttachment:"fixed"}}>
        <div className="absolute inset-0 bg-black/60 md:rounded-2xl bg-opacity-50 flex items-center justify-center ">
            <div className="text-center text-white px-4">
                <h1 className='text-3xl md:text-5xl lg:text-6xl font-bold mb-6 '>Next-Gen Electronics at your Fingertips </h1>
                ...
                <button className="bg-red-500 hover:bg-red-600 rounded-lg transition duration-300 text-white font-semibold py-2 px-4 md:py-3 md:px-6 cursor-pointer">Shop Now</button>
            </div>
        </div>
      </div>
    </div>
